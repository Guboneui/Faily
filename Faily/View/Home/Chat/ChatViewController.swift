...
class ChatViewController: UIViewController {
    ...
    static var message: [ChatMessage] = [
        ...
        ChatMessage(userName: "본의", userProfile: "본의_프로필", isPhoto: false, isSchedule: false, message: "그래서 우리 여행은 어딜로 언제 가는게 좋을까???", sendTime: "오전 8시 23분", emoticon: nil, photo: nil, scheduleDate: nil, scheduleTitle: nil),
        ...
        ChatMessage(userName: "본의", userProfile: "본의_프로필", isPhoto: false, isSchedule: false, message: "운전은 승빈이 있으니까 패스~~", sendTime: "오전 8시 23분", emoticon: nil, photo: nil, scheduleDate: nil, scheduleTitle: nil),
