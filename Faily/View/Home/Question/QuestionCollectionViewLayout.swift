//
//  QuestionCollectionViewLayout.swift
//  Faily
//
...
class QuestionCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        let hotizontalInsets = (collectionView.frame.width - collectionView.adjustedContentInset.right - collectionView.adjustedContentInset.left - width) / 2
        sectionInset = UIEdgeInsets(top: verticalInsets, left: hotizontalInsets, bottom: verticalInsets, right: hotizontalInsets)
        super.prepare()
    }
