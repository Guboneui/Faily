    ...
    var homeInfo: [HomeInfo]? {
        didSet {
            ...
            if homeInfo?[0].today_anniversary!.count == 0 {
                ...
                homeView?.scheduleTitleLabel.text = "\(homeInfo?[0].today_anniversary![Int.random(in: 0..<(homeInfo?[0].today_anniversary!.count ?? 1))].calendar_name ?? "특별한 추억을\n만들어 보세요.")"
            }
